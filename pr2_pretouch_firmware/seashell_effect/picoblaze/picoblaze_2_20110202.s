...
init:
	...
	; Setup timerB to expire every 28us (~35,715Hz) (V)
	 load s0, 1c ; 0.001ms * 28 = 0.028ms    = 0x1c
...
main_loop:
	...
	; How many times we want to read the sensors to fill in the 512 bytes buffer?
	; (512-4)bytes / 2 channel = 254
...
read_sensor:
	...
	;  wait for ADC conversion, ADCH->SPDR...
		load s0, DELAY_1US_COUNT ;(1us is too short in theory, but it works?)
		call delay_us
