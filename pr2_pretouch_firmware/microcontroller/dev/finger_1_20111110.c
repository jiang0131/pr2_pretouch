...
{  
   ...
   // Sampling Speed Prescalar
   //ADCSRA |= (1 << ADPS2) | (1 << ADPS1) | (1 << ADPS0); // (16M/128=125KHz) 
   //ADCSRA |= (1 << ADPS2) | (1 << ADPS1) | (0 << ADPS0); // (16M/64=250KHz)
   //ADCSRA |= (1 << ADPS2) | (1 << ADPS1) | (1 << ADPS0); // (16M/32=500KHz)
   //ADCSRA |= (0 << ADPS2) | (1 << ADPS1) | (1 << ADPS0) ; // (16M/8=2MHz)
   ADCSRA |= (0 << ADPS2) | (1 << ADPS1) | ( 1<< ADPS0); // (16M/4=4MHz)
